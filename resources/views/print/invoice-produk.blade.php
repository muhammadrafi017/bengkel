                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-condensed table-sm">
                                ...
                                <tbody>
                                    @foreach ($data->detailNota as $value)
                                        <tr>
                                            <td>{{ $value->produk->nama }}</td>
                                            <td>{{ number_format($value->harga_satuan,0,".",",") }}</td>
                                            <td>{{ number_format($value->kuantitas,0,".",",") }}</td>
                                            <td>{{ number_format($value->harga_satuan*$value->kuantitas,0,".",",") }}</td>
                                        </tr>
                                    @endforeach
                                <tbody>
                            </table>
                            <table class="table table-condensed table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-line text-right">{{ $data->kupon ? $data->kupon->nama : '-' }} Rp. {{ $data->kupon ? number_format($data->kupon->potongan,0,".",",") : '-' }}</td>
                                    </tr>
                                    <tr>
                                        <td class="no-line" width="75%" colspan="2"></td>
